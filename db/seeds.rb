...
phone = ['0646789465', '0764859856', '0715326548']
...
event = Event.create( name:'ramass megot', place:"paris #{i+2} ème", description: "Nous allons nous concentrer sur le rammasage de #{description_dechet[i]}")
